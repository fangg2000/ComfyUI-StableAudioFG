...
def generate_cond(
    ...
    global sample_size, sample_rate, model_type, model_half
    model = None
...
# 初始化模型信息
def init_model_info(model_config, in_model, in_model_half=True):
    global sample_size, sample_rate, model_type, model_half
